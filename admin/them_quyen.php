...
<form action="" method="post">
    <table class="table table-bordered table-striped align-middle text-center">
        ...
        <tr>
            ...
            <td><input type="checkbox" id="check_all_nguoidung" name="check_all_nguoidung"></td>
        </tr>
        <tr>
            ...
            <td><input type="checkbox" id="check_all_cauhoi" name="check_all_cauhoi"></td>
        </tr>
        <tr>
            <td>Quyền</td>
            ...
            <td><input type="checkbox" id="check_all_quyen" name="check_all_quyen"></td>
        </tr>
        <tr>
            <td>Đề thi</td>
            ...
            <td><input type="checkbox" id="check_all_dethi" name="check_all_dethi"></td>
        </tr>
        <tr>
            <td>Lớp Học</td>
            <td><input type="checkbox" id="them_lop" name="them_lop"></td>
            <td><input type="checkbox" id="sua_lop" name="sua_lop"></td>
            <td><input type="checkbox" id="xoa_lop" name="xoa_lop"></td>
            <td><input type="checkbox" id="check_all_lop" name="check_all_lop"></td>
        </tr>
        <tr>
            <td>Môn học</td>
            ...
            <td><input type="checkbox" id="check_all_monhoc" name="check_all_monhoc"></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
